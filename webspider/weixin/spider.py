...
from webspider.weixin.config import PROXY_POOL_URL, VALID_STATUSES, MAX_FAILED_TIME
from webspider.weixin.db import RedisQueue
from webspider.weixin.mysql import MySQL
